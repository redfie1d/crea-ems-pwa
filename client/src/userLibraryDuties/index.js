...
class UserAppointmentsBookings extends React.Component {
  constructor(props) {
    super(props);
...
UserAppointmentsBookings.propTypes = {
...
export default withStyles(styles, { withTheme: true })(UserAppointmentsBookings);
