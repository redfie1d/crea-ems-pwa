...
import TabExportContent from "./components/tabExportContent";
...
class AdminTabExportContent extends React.Component {
  constructor(props) {
    super(props);
...
AdminTabExportContent.propTypes = {
...
export default withStyles(styles, { withTheme: true })(AdminTabExportContent);
