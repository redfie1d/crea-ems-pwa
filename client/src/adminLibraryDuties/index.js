...
import ManageLibraryDuties from "./components/manageLibraryDuties";
...
class AdminLibraryDuties extends React.Component {
  constructor(props) {
    super(props);
...
export default withStyles(styles, { withTheme: true })(AdminLibraryDuties);
