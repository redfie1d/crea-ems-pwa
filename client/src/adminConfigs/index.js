...
import ManageConfigs from "./components/manageConfigs";
...
class AdminManageConfigs extends React.Component {
  constructor(props) {
    super(props);
...
export default withStyles(styles, { withTheme: true })(AdminManageConfigs);
